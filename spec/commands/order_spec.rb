require 'spec_helper'
require 'tddium/cli'
require 'tddium/cli/commands/order'
require 'tmpdir'
...
describe Tddium::TddiumCli do
  describe "#order" do
    ...
    def run_valid_order
      subject.order(["a.rb", "b.rb", "c.rb", "c.rb"])
    end
    ...
    it "finds the polluter in a bigger set" do
      ...
      subject.should_receive(:say).with("Fails when b.rb, c.rb are run together")
      subject.order(["a.rb", "0.rb", "1.rb", "2.rb", "b.rb", "3.rb", "4.rb", "5.rb", "6.rb", "7.rb", "c.rb", "8.rb", "9.rb", "c.rb"])
    end
  end
end
